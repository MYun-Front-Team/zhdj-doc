...
| TotalStatusList|array[int] | 否 | 状态（0草稿，1已提交，2考勤已发放（待员工核对）， 3部分员工核对，4全部员工核对（待回款），5已回款，11平台退回，12员工退回，9部分发放薪水， 10已发薪水） |
...
| FinishStatusList| array[int] | 否 |是否发薪水(0初始，1部分发薪水 10已发)|
...
| TotalStatus| int | 是 | 状态（0草稿，1已提交，2考勤已发放（待员工核对）， 3部分员工核对，4全部员工核对（待回款），5已回款，11平台退回，12员工退回，9部分发放薪水，10已发薪水） |
...
| FinishStatus| int| 是 |是否发薪水(0初始，1部分发薪水，10已发)|
